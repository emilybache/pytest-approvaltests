# -*- coding: utf-8 -*-
#
# pytest-approvaltests documentation build configuration file, created by
...
project = u'pytest-approvaltests'
copyright = u'2019, Emily Bache'
author = u'Emily Bache'
...
man_pages = [
    (master_doc, 'pytest-cookiecutterplugin_name', u'pytest-approvaltests Documentation',
     [author], 1)
]
